...
$(window).on("load", function() {
   ...
   *
   * No tiene que ver con los controles del juego. Es para pausar, cargar mundo,
   * salvar
   *
  ...
  Backbone.Controller = Backbone.Model.extend({
    initialize: function(attributes, options) {
       ...
       * SpriteCollection.attachToSpriteClasses() para amarrar las clases.
       */
      ...
      // User input (turn off touchpad to start) el control del usuario
    ...
    /**
     * Actualiza state entre pause y play
     */
    toggleState: function(e) {
      var state = this.world.get("state");
      this.world.set("state", state == "pause" ? "play" : "pause");
      // si está parado inicia el motor
      if (!this.engine.isRunning()) this.engine.start();
    },

    /**
     * Modifica el canvas según el estado.
     *
     * Es disparado por el cambio en el atributo state.
     */
    onChangeState: function() {
      ...
      if (state == "pause") {
        ...
        // agrega los botones de salvar y reiniciar
    ...
    /**
     * Salva el mundo en el localStorage. o servidor
     *
    ...
    /**
     * Carga el mundo en el localStorage. o servidor
     *
     * @return this
     */
    loadWorld: function() {
